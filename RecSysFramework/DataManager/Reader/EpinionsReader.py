...
from RecSysFramework.DataManager.Utils import downloadFromURL, load_CSV_into_SparseBuilder, load_CSV_into_SparseBuilder_epinions
...
class EpinionsReader(DataReader):
    ...
    def _load_from_original_file(self):
        ...
        URM_all, item_mapper, user_mapper = load_CSV_into_SparseBuilder_epinions(decompressed_file_path, separator=" ")
