...
class YahooMovies(DataReader):
    ...
    def __init__(self, reload_from_original_data=False):
        super(YahooMovies, self).__init__(reload_from_original_data)
    ...
    def _load_from_original_file(self):
        ...
        try:
            ...
            print("YahooMovies: Data can be downloaded here: {}".format(self.DATASET_URL))
        ...
        return Dataset(self._get_dataset_name(),
