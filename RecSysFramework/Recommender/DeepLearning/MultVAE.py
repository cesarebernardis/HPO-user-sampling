...
class MultVAE(Recommender, EarlyStoppingModel, BaseTempFolder):
    ...
    def fit(self,
        ...
        self.vae = MultVAE_original(self.p_dims, q_dims=self.q_dims, lr=self.learning_rate, lam=self.l2_reg, random_seed=98765)
...
class MultVAE_OptimizerMask(MultVAE):
    ...
    def fit(self, epochs=100, batch_size=500, total_anneal_steps=200000, learning_rate=1e-3, l2_reg=0.01,
            dropout=0.5, anneal_cap=0.2, temp_file_folder=None, p_dims=64, **kwargs):
        ...
        super(MultVAE_OptimizerMask, self).fit(epochs=epochs, batch_size=batch_size, dropout=dropout, learning_rate=learning_rate,
